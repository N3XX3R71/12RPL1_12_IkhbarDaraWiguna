...
if(isset($_GET['search']) && isset($_GET['submit'])) {
    ...
    $query = "SELECT * FROM post
              ...
              OR category_id IN (SELECT id FROM categories WHERE title LIKE '%$search%') 
      ...
      <?php while($post = mysqli_fetch_assoc($posts)) : ?>
        <article class="post">
          ...
          <?php 
                ...
                ?>
          <div class="post_info">
            <a href="<?= ROOT_URL ?>category.php?id=<?= $category['title'] ?>" class="category_button"><?= $category['title'] ?></a>
            <h3 class="post_title">
